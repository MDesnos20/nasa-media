...
import 'package:socle/features/movies/data/repositories/movies_repository_impl.dart';
...
void main() async {
  ...
  group('getMovieById', () {
    ...
    runTestsOnline(() {
      ...
      test('should return movie on success', () async {
        // Arrange
        // Act
        final result = await repository.getMovieById(id, locale);
        // Assert
        verify(
  ...
  group('getMovies', () {
    final expectedResult = PageOfMoviesModel(
      page: 1,
      totalPages: 35500,
      totalResults: 709985,
      results: [
    ...
    runTestsOnline(() {
      ...
      test('should return movies on success', () async {
        // Arrange
        // Act
        final result = await repository.getMoviesByPage(page, locale);
        // Assert
        verify(

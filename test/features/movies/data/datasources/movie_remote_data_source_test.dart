...
void main() async {
  ...
  group('getMovies', () {
    ...
    test('Should get movies list', () async {
      // arrange
      final route = GlobalConfiguration().getValue('api_base_url') + ApiConstants.popularMoviesPath;
      adapter.onGet(
        route,
        queryParameters: {
  ...
  group('getMovieById', () {
    ...
    test('Should get single movie', () async {
      // arrange
      final route = GlobalConfiguration().getValue('api_base_url') + ApiConstants.moviePath(movieId);
      adapter.onGet(
        route,
        queryParameters: {
          'api_key': GlobalConfiguration().getValue('api_key'),

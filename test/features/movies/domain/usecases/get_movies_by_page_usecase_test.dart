...
import 'package:socle/features/movies/domain/usecases/get_movies_by_page_usecase.dart';

import './get_movies_by_page_usecase_test.mocks.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      // Arrange
      when(
        mockMoviesRepository.getMoviesByPage(any, any),
      ...
      verify(mockMoviesRepository.getMovieById(params.page, params.locale));
